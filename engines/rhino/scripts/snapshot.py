...
# Ответ Rhino приходит напечатанной строкой через несколько слоёв
# перекодировки, и кириллица в ней превращается в мусор — видно на именах
# слоёв. Экранирование делает строку целиком из ASCII, которому эти слои
# уже не вредят.
